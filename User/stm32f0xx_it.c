...
extern void hwtmr1_irqHandler(void);
extern void hwtmr2_irqHandler(void);
extern void _USARTX_IRQHandler(USART_TypeDef* COM);
...
void USART3_8_IRQHandler(void)
{
	...
	_USARTX_IRQHandler(USART4);
	_USARTX_IRQHandler(USART5);
	_USARTX_IRQHandler(USART6);
	_USARTX_IRQHandler(USART7);
	_USARTX_IRQHandler(USART8);	
}
